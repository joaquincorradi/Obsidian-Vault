...
2. Sea la matriz $\left[\begin{array}{@{}cccccc|c@{}} a_{11} & a_{12} & \cdots & a_{1r} & \cdots & a_{1n} & b_1 \\ 0 & a_{22} & \cdots & a_{2r} & \cdots & a_{2n} & b_2 \\ \vdots & \vdots & \vdots & \vdots & \ddots & \vdots & \vdots \\ 0 & 0 & \cdots & a_{rr} & \cdots & a_{rn} & b_r \end{array}\right]$ asociada al sistema resolvente, se concluye que el sistema es <u>compatible</u>. Las variables (o incógnitas) principales corresponden a las <u>columnas pivote</u> en la matriz <u>escalonada</u>. Las variables que pueden tomar valores arbitrarios se llaman <u>variables libres</u>.
3. En el <u>primer</u> cuadrante las funciones trigonométricas son positivas. En particular la función $4\sin(2\theta-1)+3$, el $4$ representa la <u>amplitud</u>, el $3$ representa el <u>desplazamiento vertical</u>, el periodo es <u>π</u> y el ángulo de fase vale <u>un medio</u>.
4. Un vector es <u>un segmento de recta dirigido</u>. El origen de coordenadas da lugar al vector <u>nulo</u>. Hay dos operaciones fundamentales a tener en cuenta durante el trabajo con vectores: <u>la suma y multiplicación de vectores</u>. Estas dos operaciones dan lugar a la <u>combinación lineal</u>.